---
title: "Laboratorio 03: R - Datos vectoriales 1"
author: "Fernanda Zúñiga"
date: "2020-05-11"
output:
  html_document:
    theme: readable    
...
```{r} 
 ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida de los paises de America Central") +
  xlab("CPaises") + 
  ylab("Esperanza") +  
  geom_col() +
...
```{r} 
 plot(centro_america ["lifeExp"], main="Esperanza de vida de los países de América Central")
```
...
```{r} 
centroamerica_expvida = world[(world$name_long == "Belize" |
                       world$name_long == "Guatemala" |
                       world$name_long == "Honduras" |
                       world$name_long == "El Salvador" |
                       world$name_long == "Nicaragua" |
                       ...
                       world$name_long == "Panama") & world$lifeExp >= 74 
                                              ...
                                              , ]
 plot(centroamerica_expvida ["lifeExp"], main="Esperanza de vida de los países de América Central mayor o igual a 74 años")
```